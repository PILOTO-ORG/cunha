// ========================================
// CÓDIGO N8N COMPLETO CORRIGIDO - CUNHA FESTAS cunha
// ========================================
...
switch (action) {
  ...
  case 'verificar_disponibilidade':
    ...
    return await executeQuery(`
      ...
      FROM cunha.produtos p
      LEFT JOIN cunha.itens_reserva ir ON p.id_produto = ir.id_produto
      LEFT JOIN cunha.reservas r ON ir.id_reserva = r.id_reserva
      WHERE p.id_produto = $1
  ...
  case 'criar_cliente':
    ...
    return await executeQuery(`
      INSERT INTO cunha.clientes (nome, telefone, email, cpf_cnpj)
      VALUES ($1, $2, $3, $4)
  ...
  case 'criar_local':
    ...
    return await executeQuery(`
      INSERT INTO cunha.locais (descricao, endereco, capacidade, tipo)
      VALUES ($1, $2, $3, $4)
  ...
  case 'listar_reservas':
    return await executeQuery(`
      ...
      FROM cunha.itens_reserva ir
      JOIN cunha.reservas r ON ir.id_reserva = r.id_reserva
      JOIN cunha.clientes c ON r.id_cliente = c.id_cliente
      JOIN cunha.locais l ON r.id_local = l.id_local
      JOIN cunha.produtos p ON ir.id_produto = p.id_produto
  ...
  case 'criar_reserva':
    ...
    return await executeQuery(`
      WITH nova_reserva AS (
        INSERT INTO cunha.reservas (id_cliente, id_local, data_inicio, data_fim, status)
        VALUES ($1, $2, $3, $4, $5)
        RETURNING id_reserva
      ),
      novo_item AS (
        INSERT INTO cunha.itens_reserva (id_reserva, id_produto, quantidade)
  ...
  case 'atualizar_status_reserva':
    ...
    return await executeQuery(`
      ...
      SET status = $1
      WHERE id_reserva = (
        SELECT id_reserva FROM cunha.itens_reserva WHERE id_item_reserva = $2
      )
  ...
  case 'listar_movimentos':
    return await executeQuery(`
      SELECT 
        ...
        e.reserva_id,
        p.nome as produto_nome
      FROM cunha.eventos_estoque e
      JOIN cunha.produtos p ON e.id_produto = p.id_produto
  ...
  case 'criar_movimento':
    ...
    return await executeQuery(`
      INSERT INTO cunha.eventos_estoque (
        id_produto, 
        tipo_evento, 
        quantidade, 
        observacao, 
